...
# Generate a New Trajectory Using the Trained Models
with torch.no_grad():
...
# Plot the Expert and Generated Trajectories
plt.figure(figsize=(20, 8))

plt.plot(generated_trajectory[:, 0], generated_trajectory[:, 1], 'r-', label='Generated (Up)')
plt.plot(generated_trajectory_rev[:, 0], generated_trajectory_rev[:, 1], 'y-', label='Generated (Down)')

# Plot the central obstacle
ox, oy, r = obstacle
...
plt.grid(True)
plt.legend()
plt.savefig('figures/two_agent/dual_mode/dual_mode_trajectories.png')
plt.show()
